...
* CivNeedsPlaceFirstCoastalStart(civType)
* CivPrefersMountainStart(civType)
* CivPrefersSnowStart(civType)
...
------------------------------------------------------------------------------
function CivPrefersMountainStart(civType)
	-- This function retrieves Start Prefer Mountain bias from the XML.
...
------------------------------------------------------------------------------
function CivPrefersSnowStart(civType)
	-- This function retrieves Start Prefer Snow bias from the XML.
